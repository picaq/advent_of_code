...
hydro = (arr, diag = false) => makeGraph(arr, diag).flat().filter( x => x > 1 ).length;

// part 1
console.log(hydro(arr));
console.log(hydro(arr2));

// part 2
console.log(hydro(arr, true));
// console.log(makeGraph(arr, true));
console.log(hydro(arr2, true));
